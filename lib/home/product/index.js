function navTab() {
	...
	$('.cello-product .cello-navTab .cello-tabList .item').on('click', function () {
		$('.cello-product .cello-navTab .cello-tabList .item').removeClass('active')
		$(this).addClass('active')
		let i = $(this).attr('cello-tabItem')
		$('.cello-product .cello-tabContent .list-item').removeClass('active')
		$('.cello-product .cello-tabContent .list-item[cello-tabContent=' + i + ']').addClass('active')
