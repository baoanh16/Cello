		...
		<section class="cello-thuonghieu-ct">
			<div class="container">
				<div class="filter-nav">
					<xsl:apply-templates select="/ManufacturerDetail/Group"></xsl:apply-templates>
					...
					<div class="select">
						...
						<div class="select-list">
							<div class="select-item">test</div>
							<div class="select-item">test2</div>
						</div>
					</div>
					<div class="select">
						<div class="select-show">
						...
						<div class="select-list">
							<div class="select-item">Nổi bật</div>
							<div class="select-item">Giá từ thấp đến cao</div>
