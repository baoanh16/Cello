					...
					<div class="row">
								...
								<div class="cobra">
									...
									<div class="code">
										...
										<span class="product-code">
											<xsl:value-of select="/ProductDetail/Code" disable-output-escaping="yes">
											</xsl:value-of>
										</span>
									</div>
									<div class="brand">
						...
						<div class="col-xl-7 table">
							...
							<div class="productButton">
								...
								<a class="btnBuy" href="#">Mua trả góp</a>
							</div>
							<div class="socialShare">
								...
								<a class="zalo zalo-share-button" data-customize="true" data-oaid="579745863508352884"
									data-color="red">
						...
						<div class="col-xl-5">
							<xsl:if test="/ProductDetail/PromotionDetail != ''">
								<div class="giftBox">
									<h4> <span class="fas fa-gift"></span><span>QUÀ TẶNG &amp; KHUYẾN MÃI</span></h4>
									<div class="item">
										<xsl:value-of select="/ProductDetail/PromotionDetail"
											disable-output-escaping="yes" />

									</div>
									<div class="bottom"><span>*</span><span>Số lượng quà tặng có hạn</span></div>
								</div>
				...
				<div class="col-lg-4">
					...
					<xsl:if test="count(/ProductDetail/ProductBuyWith)&gt;0">
						<div class="productMuaKem">
							...
							<div class="swiper-container">
								<div class="swiper-wrapper">
									<xsl:apply-templates select="/ProductDetail/ProductBuyWith"></xsl:apply-templates>
								</div>
							</div>
						</div>
					</xsl:if>
